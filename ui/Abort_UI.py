...
class Ui_Abort(object):
    ...
    def retranslateUi(self, Abort):
        ...
        self.label.setText(QCoreApplication.translate("Abort",
                                                      u"<html><head/><body><p><a href=\"https://github.com/KR-Rabbit/LabelStudioLauncher/blob/main/README.md\"><span style=\" text-decoration: underline; color:#0000ff;\">Here</span></a></p></body></html>",
                                                      None))
    # retranslateUi
