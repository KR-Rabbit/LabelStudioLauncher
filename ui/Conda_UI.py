...
class Ui_Conda(object):
    def setupUi(self, Conda):
        ...
        sizePolicy.setHeightForWidth(Conda.sizePolicy().hasHeightForWidth())
        Conda.setSizePolicy(sizePolicy)
        ...
        self.label_conda_tip.setGeometry(QRect(70, 30, 101, 25))
        self.lineEdit_conda = QLineEdit(self.centralwidget)
        self.lineEdit_conda.setObjectName(u"lineEdit_conda")
        self.lineEdit_conda.setGeometry(QRect(200, 30, 256, 25))
        ...
        self.pushButton_select.setGeometry(QRect(470, 30, 80, 25))
        ...
        self.lineEdit_env_name.setGeometry(QRect(200, 120, 160, 25))
        ...
        self.label_version_tip.setGeometry(QRect(70, 160, 100, 25))
        ...
        self.comboBox_version.setGeometry(QRect(200, 160, 80, 22))
        ...
        self.create_btn.setGeometry(QRect(360, 160, 75, 24))
        self.textBrowser = QTextBrowser(self.centralwidget)
        self.textBrowser.setObjectName(u"textBrowser")
        self.textBrowser.setGeometry(QRect(70, 200, 481, 141))
        ...
        self.create_btn.clicked.connect(Conda.create_env)
    ...
    def retranslateUi(self, Conda):
        ...
        self.label_conda_tip.setText(QCoreApplication.translate("Conda", u"Conda\u53ef\u6267\u884c\u6587\u4ef6\uff1a", None))
        self.pushButton_select.setText(QCoreApplication.translate("Conda", u"\u9009\u62e9", None))
        self.radioButton_current.setText(QCoreApplication.translate("Conda", u"\u4f7f\u7528\u73b0\u6709\u73af\u5883", None))
        ...
        self.create_btn.setText(QCoreApplication.translate("Conda", u"\u786e\u5b9a", None))
    # retranslateUi
